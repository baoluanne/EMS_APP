...
export const KeHoachDaoTao_NienCheSchema = z.object({
  idHocKy: z.string({ required_error: 'Học kỳ là bắt buộc' }).uuid().min(1, 'Học kỳ là bắt buộc'),
  ghiChu: z.string().nullable().optional(),
});

export type KeHoachDaoTao_NienChe = z.infer<typeof KeHoachDaoTao_NienCheSchema>;

const ChuongTrinhKhungNienCheSchema = z.object({
...
export const ChiTietKhungHocKy_NienCheSchema = z.object({
  id: z.string().uuid().optional(),
  ...
  chuongTrinhKhungNienChe: ChuongTrinhKhungNienCheSchema.optional(),
});

export type ChiTietKhungHocKy_NienChe = z.infer<typeof ChiTietKhungHocKy_NienCheSchema>;
