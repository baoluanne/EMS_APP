...
export const ChiTietChuongTrinhKhung_NienCheSchema = z.object({
  id: z.string().uuid().optional(),
  isBatBuoc: z.boolean().optional(),
  idMonHocBacDaoTao: z.string().uuid().optional(),
  monHocBacDaoTao: MonHocBacDaoTaoSchema.optional(),
  hocKy: z.number().int(),
  soNienCheBatBuoc: z.number().int().optional(),
  soNienCheTuChon: z.number().int().optional(),
  idChuongTrinhKhung: z.string().uuid().optional(),
  chuongTrinhKhungNienChe: ChuongTrinhKhungNienCheSchema.optional(),
});

export type ChiTietChuongTrinhKhung_NienChe = z.infer<typeof ChiTietChuongTrinhKhung_NienCheSchema>;
