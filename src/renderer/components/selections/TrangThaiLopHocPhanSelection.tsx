...
import { TRANG_THAI_LHP_OPTIONS } from '@renderer/shared/constants';
...
export const TrangThaiLopHocPhanSelection = <T extends boolean = false>({
  multiple,
  value,
  onChange,
  control,
    ...
    <Stack>
      {isMultiple ? (
        <FilterMultiSelect
          ...
          options={TRANG_THAI_LHP_OPTIONS}
