...
interface BangDiemTotNghiepSelectionProps {
  value?: string;
...
export const BangDiemTotNghiepSelection: FC<BangDiemTotNghiepSelectionProps> = ({
  value,
  onChange,
  name,
  control,
  ...
  return (
    <Stack>
      <FilterSelect
        label={`Bảng điểm tốt nghiệp${required ? '*' : ''}`}
