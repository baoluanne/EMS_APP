...
import {
  ...
  DangKyHocPhanTuDoFilter,
} from '@renderer/features/hoc-vu-sinh-vien/quan-ly-dang-ky-hoc-phan/dang-ky-hoc-phan-tu-do';
...
export default function DangKyHocPhanTuDo() {
  ...
  return (
    <Stack
      ...
      gap={1}
    >
      <DangKyHocPhanTuDoFilter onApply={(value) => mergeParams(value)} />
